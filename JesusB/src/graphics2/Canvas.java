...
public class Canvas
{
    ...
    public static void acierto()
    {
        JFrame frame = getInstance().frame;
        if (frame == null) return;
        JOptionPane.showMessageDialog(frame, "¡ BRAVO, ACERTASTE UNA LETRA !!");
    }
    /*
    ...
    public static void fallo()
    {
        JFrame frame = getInstance().frame;
        if (frame == null) return;
        JOptionPane.showMessageDialog(frame, " TÍO NO ACIERTAS UNA...");
    }
    /*
    ...
    public static void bienvenida()
    {
        ...
        JOptionPane.showMessageDialog(frame,  "                    ESTE ES EL JUEGO DEL AHORCADO."
        		+ "\n DEBES ACERTAR LA PALABARA SECRETA SIN LLEGAR A 8 ERRORES."
