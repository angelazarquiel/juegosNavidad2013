...
public class ImposibleF1main_prueba1 {

	public static Rectangle enemigo1;
	public static Rectangle enemigo2;
	public  static Rectangle enemigo3;
	public static Rectangle enemigo4;
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		 Point click;
		 do {
		 click = Canvas.getInstance().waitMouseClick();
		 } while ();
		 */
...
*/
	...
	private static void crearPantalla() {
		...
		Rectangle pantalla = new Rectangle(50, 50, 750, 750);
